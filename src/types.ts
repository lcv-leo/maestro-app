...
export type AiCredentialKey = 'openai' | 'anthropic' | 'gemini' | 'deepseek';
export type InitialAgentKey = 'claude' | 'codex' | 'gemini' | 'deepseek';
export type ProviderRateKey = AiCredentialKey;
export type NativeAttachmentProvider = Exclude<AiCredentialKey, 'deepseek'>;
